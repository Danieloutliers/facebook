...
export default function NotificationDropdown() {
  ...
  // Enviar notificações push quando houver empréstimos atrasados
  useEffect(() => {
    // Só enviar notificações se houver mudança na quantidade de empréstimos atrasados
    ...
    if (notifications.length > 0 && 
      ...
      if ('Notification' in window && Notification.permission === 'granted') {
        ...
        // Enviar notificações para cada empréstimo atrasado que ainda não foi notificado
