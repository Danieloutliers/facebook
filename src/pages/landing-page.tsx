...
import { Check, Smartphone, Download, CreditCard, BarChart3, Users, Shield, Clock, Zap, Globe, TrendingUp, ChevronDown, Play } from "lucide-react";
...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    videoScript.src = 'https://fast.wistia.com/embed/btepmofb52.js';
    ...
    style.textContent = `
      wistia-player[media-id='btepmofb52']:not(:defined) { 
        background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/btepmofb52/swatch'); 
        display: block; 
        filter: blur(5px); 
        padding-top: 56.25%; 
      }
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-6">Veja o loanBuddy em Ação</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Descubra como transformar sua gestão financeira com uma demonstração completa do sistema. 
              Veja todas as funcionalidades em detalhes.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-8">
              ...
              <div className="mt-8 text-center">
                <h3 className="text-2xl font-bold mb-4">Demonstração Completa do Sistema</h3>
                <p className="text-gray-600 mb-6">
                  Assista ao vídeo e descubra como o loanBuddy pode revolucionar sua gestão de empréstimos
                </p>
