  ...
  try {
    ...
    const getLoansInPeriod = (period: 'current' | 'previous' | 'last3months' = 'current') => {
      ...
      return loans.filter(loan => {
        // Filtrar apenas empréstimos não arquivados
    ...
    const getHistoricalData = () => {
      ...
      for (let i = 5; i >= 0; i--) {
        ...
        // Calcular valor total emprestado no mês
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    <div className="flex items-center space-x-2 mb-6">
                      ...
                      <h3 className="text-xl font-semibold">Relatório Mensal e Trimestral</h3>
                    </div>
                      ...
                      <Card className="overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow duration-300">
                        ...
                        <CardHeader className="pb-2">
                          <CardTitle className="text-base font-medium flex items-center">
                            ...
                            Valor Emprestado (Últimos 3 Meses)
                          </CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <div className="grid grid-cols-1 gap-8">
                      ...
                      <Card className="overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300">
                        ...
                        <CardHeader className="pb-2">
                          ...
                          <CardDescription>Evolução do número de empréstimos nos últimos 6 meses</CardDescription>
                        </CardHeader>
                        <CardContent>
